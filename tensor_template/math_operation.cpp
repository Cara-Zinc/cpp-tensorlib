...
namespace ts
{
    ...
    template Tensor<int> operator+<int>(const Tensor<int>&, const Tensor<int>&);
    template Tensor<float> operator+<float>(const Tensor<float>&, const Tensor<float>&);
    template Tensor<double> operator+<double>(const Tensor<double>&, const Tensor<double>&);
